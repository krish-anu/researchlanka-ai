...
CSV_COLUMNS = [
    ...
    "doi",
    "url",
    # OpenAlex-only columns; blank for repository records.
    "cited_by_count",
    "is_open_access",
    "oa_status",
    "pdf_url",
...
def record_to_row(record: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "funding": unique_join(record.get("funding")),
        ...
        "topics": unique_join(record.get("topics")),
        "affiliated_institutions": unique_join(record.get("affiliated_institutions")),
