...
function ImpactPanel({ publication }: { publication: PublicationDetail }) {
  ...
  return (
    <section className="panel p-4">
      ...
      {diverges ? (
        <p className="mt-3 flex gap-2 rounded-md border border-serious/40 bg-wash p-2 text-body-sm text-ink-secondary">
  ...
  return (
    <article className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <section className="panel p-4">
          <h2 className="font-display text-h3 text-ink">Venue &amp; access</h2>
          <dl className="mt-2">
            <Field label="Journal">
