...
- **Generated (UTC):** 2026-09-12T09:18:43.897401+00:00
- **Total tests:** 77
- **Passed:** 73
- **Failed:** 4
- **Skipped:** 0
...
|---|---:|---:|---:|---:|---:|
| cleaning | 34 | 32 | 2 | 0 | 94.12% |
| dagster | 3 | 3 | 0 | 0 | 100.0% |
| database | 3 | 2 | 1 | 0 | 66.67% |
| deduplication | 5 | 5 | 0 | 0 | 100.0% |
| disambiguation | 6 | 5 | 1 | 0 | 83.33% |
...
|---|---|---:|---|
| cleaning | failed | 0.001 | `test_normalize_doi_edge_cases[10.1000/abc (online)-10.1000/abc(online)]` |
| cleaning | failed | 0.001 | `test_normalize_list_like_handles_null_markers_and_separators` |
...
| cleaning | passed | 0.001 | `test_normalize_publication_date_edge_cases[2024-03-2024-03]` |
...
| dagster | passed | 0.000 | `test_dagster_source_file_declares_pipeline_stages` |
| dagster | passed | 0.001 | `test_definitions_entrypoint_loads` |
| dagster | passed | 1.440 | `test_researchlanka_job_definitions_exist` |
| database | failed | 0.001 | `test_publication_key_prefers_doi` |
...
| deduplication | passed | 0.000 | `test_doi_duplicates_auto_merge_even_with_different_titles` |
...
| disambiguation | failed | 0.001 | `test_different_orcids_do_not_merge_even_with_same_name` |
...
| e2e_ingestion | passed | 0.003 | `test_database_row_contract_from_pipeline_output` |
| e2e_ingestion | passed | 0.007 | `test_end_to_end_pipeline_stages` |
...
| preprocessing | passed | 0.025 | `test_clean_text_series_collapses_and_strips` |
| preprocessing | passed | 0.003 | `test_cleaning_report_counts_affected_rows` |
...
### `tests/phase1/test_phase1_cleaning.py::test_normalize_doi_edge_cases[10.1000/abc (online)-10.1000/abc(online)]`

- Category: `cleaning`
- Message: `raw = '10.1000/abc (online)', expected = '10.1000/abc(online)'      @pytest.mark.edge_case     @pytest.mark.parametrize(         "raw,expected",         [             (None, None),             ("", None),             ("   ", None),             ("nan", None),             (math.nan, None),             ("https://doi.org/10.1000/ABC", "10.1000/abc"),             ("DOI: 10.1000/ABC.", "10.1000/abc"),             ("http://dx.doi.org/10.1000/xyz;", "10.1000/xyz"),             ("10.1000/abc (online)", "10.1000/abc(online)"),         ],     )     def test_normalize_doi_edge_cases(raw, expected): >       assert normalize_doi(raw) == expected E       AssertionError: assert '10.1000/abc(online' == '10.1000/abc(online)' E          E         - 10.1000/abc(online) E         ?                   - E       `

### `tests/phase1/test_phase1_cleaning.py::test_normalize_list_like_handles_null_markers_and_separators`

- Category: `cleaning`
- Message: `@pytest.mark.edge_case     def test_normalize_list_like_handles_null_markers_and_separators():         assert normalize_list_like(None) == []         assert normalize_list_like("") == []         assert normalize_list_like("A; B; ; C", separators=(";",)) == ["A", "B", "C"] >       assert normalize_list_like(["A", "", None, "B"]) == ["A", "B"] E       AssertionError: assert ['A', 'None', 'B'] == ['A', 'B'] E          E         At index 1 diff: 'None' != 'B' E         Left contains one more item: 'B' E         Use -v to get more diff  tests/phase1/test_phase1_cleaning.py:119: AssertionError`

### `tests/phase1/test_phase1_database.py::test_publication_key_prefers_doi`

- Category: `database`
- Message: `@pytest.mark.edge_case     def test_publication_key_prefers_doi():         row = {"doi": "https://doi.org/10.1000/ABC", "openalex_id": "W1", "title": "T"} >       assert build_publication_key(row, 1) == "doi:10.1000/abc" E       AssertionError: assert 'doi:https://...g/10.1000/ABC' == 'doi:10.1000/abc' E          E         - doi:10.1000/abc E         + doi:https://doi.org/10.1000/ABC  tests/phase1/test_phase1_database.py:16: AssertionError`

### `tests/phase1/test_phase1_disambiguation.py::test_different_orcids_do_not_merge_even_with_same_name`

- Category: `disambiguation`
- Message: `@pytest.mark.edge_case     def test_different_orcids_do_not_merge_even_with_same_name():         index = AuthorVariantIndex()         index.add_record(             make_record(authors="Perera, K.", author_orcids=ORCID_A),             record_id="r1",         )         index.add_record(             make_record(authors="Perera, K.", author_orcids=ORCID_B),             record_id="r2",         )         result = disambiguate_authors(index) >       assert len(result.clusters) == 2 E       AssertionError: assert 1 == 2 E        +  where 1 = len({'AD69AE4FB5D3': AuthorCluster(author_id='AD69AE4FB5D3', preferred_name='Perera, K', surname='Perera', variant_keys=('...igh', review_reasons=(), year_min=2020, year_max=2020, sources=('openalex',), records=('r1', 'r2'), merge_evidence=())}) E        +    `


## Artifacts

- CSV table: `phase1_etl_pipeline_20260912T091843Z_results.csv`
- JSON summary: `phase1_etl_pipeline_20260912T091843Z_summary.json`
- This report: `phase1_etl_pipeline_20260912T091843Z_report.md`
