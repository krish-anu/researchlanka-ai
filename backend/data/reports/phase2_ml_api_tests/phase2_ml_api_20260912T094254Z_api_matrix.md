...
| API-008 | `GET /api/v1/search/suggest?q=Malaria` | Autocomplete suggestions | suggestion list with publication type | **FAIL** |
...
| API-012 | `GET /api/v1/topics` | Topic directory (OpenAlex fallback when NMF unavailable) | list/ranking payload or service error handled | **FAIL** |
