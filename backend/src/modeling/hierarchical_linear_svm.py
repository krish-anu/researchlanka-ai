...
def load_labeled_frame(
    ...
    *,
    ...
    labeled = frame[
        frame[field_column].notna() & frame[subfield_column].notna()
    ].copy()
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--min-df", type=parse_document_frequency, default=DEFAULT_MIN_DF)
    parser.add_argument("--max-df", type=parse_document_frequency, default=DEFAULT_MAX_DF)
