...
_NAME_TO_MODULE = {
    ...
    "ClassificationComparisonConfig": "src.modeling.classification_comparison",
    "ClassificationComparisonResult": "src.modeling.classification_comparison",
    "compare_classification_models": "src.modeling.classification_comparison",
